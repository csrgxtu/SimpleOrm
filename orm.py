...
if __name__ == '__main__':
    ...
    db.create_engine('root', 'root', 'orm', 'localhost')
    db.update('drop table if exists Person')
    db.update('create table Person (id int primary key, name text, email text, passwd text, last_modified real)')
    ...
    p = Person(
        id=10190,
        name='Michael',
        email='archer.li@shopeemobile.com'
    )
